...
Each subsequent line will have one additional user-specified character until the number in the triangle's base reaches
...
if __name__ == '__main__':
    ...
    for number in range(1, triangle_height + 1, 1):
        print((" ".join(triangle_char * number)), end=" \n")
